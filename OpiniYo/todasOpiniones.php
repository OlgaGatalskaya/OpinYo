...
$Previous = max(1, $page - 1); // no menos de 1
$Next = min($page + 1, $pages); // no mas de las páginas si las sumamos

//veremos si botones son activos
            ...
            <div class="row">
                ...
                <div class="columna-opiniones col-12 col-lg-8">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-9">
                                            <div class="row text-end">
                                                <div class="col-5">
                                                    <button data-type="fecha" type="button" id="filtrFecha" class="btn btn-link filtr p-0">por fecha</button>
                                                </div>
                                                <div class="col-7">
                                                    <button data-type="puntuacion" type="button" id="filtrPuntuacion" class="btn btn-link filtr p-0">por puntuación</button>
                                                </div>
                                            </div>
                    ...
                    <div class="cards" id="cards">
                        <?php $todas_opiniones = todas_opiniones($start, $limit);
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    <li class="page-item <?= $previousDisabled ?>">
                                        <a class="page-link" href="todasOpiniones.php?page=<?= $Previous ?>" tabindex="-1">Anterior</a>
                                    </li>
                                    <?php for($i = 1; $i <= $pages; $i++) { ?>
                                        <li class="page-item <?= ($i == $page) ? 'active' : '' ?>">
                                            <a class="page-link" href="todasOpiniones.php?page=<?= $i ?>"><?= $i ?></a>
                                        </li>
                                    <?php } ?>
                                    <li class="page-item <?= $nextDisabled ?>">
                                        <a class="page-link" href="todasOpiniones.php?page=<?= $Next ?>">Siguiente</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
