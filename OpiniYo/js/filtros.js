//filtro por fecha
let btnFiltrFecha = document.querySelector('#filtrFecha');
let btnFiltrPun = document.querySelector('#filtrPuntuacion');
...
function filtrar(tipoFiltr){
    ...
    fetch('filtros.php', {
        ...
        .then(data => {
            console.log(data);
            pintarOpinionesOrdenados(data);
    })
}

function pintarOpinionesOrdenados(datos) {
